...
MenuPrintFunctions::MenuPrintFunctions()
{
}


void MenuPrintFunctions::EnigmaApp()
{
	User user;
...
void MenuPrintFunctions::printEnigma()
{
	cout << "===================================================================="
...
void MenuPrintFunctions::printLine()
{
	cout << "====================================================================" << endl;
}

void MenuPrintFunctions::printStartMenu(User user)
{
	printLine();
	cout << "                          MENI                              " << endl;
	printLine();
...
void MenuPrintFunctions::printGameMenu(User user, Game game, string gameNumber)
{
	printLine();
...
void MenuPrintFunctions::rollCredits()
{
	printLine();
